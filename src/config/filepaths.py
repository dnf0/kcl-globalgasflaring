...
path_to_temp = '/group_workspaces/cems/nceo_aerosolfire_OLD/data/temp/sls_unzipped_test'
path_to_sls_pix_sizes = '/group_workspaces/cems/nceo_aerosolfire_OLD/data/temp/external/slstr_500m_pixel_size.txt'

# Paths to processing output folder on CEMS
output_root = '/group_workspaces/cems/nceo_aerosolfire_OLD/data/temp/'
